    ...
    <div className="container">
      <div className="content has-text-centered">
        ...
        <Link
          ...
          target="_blank"
          to="https://twitter.com/intent/tweet?text=Check%20out%20School%20Review%20Hub&url=https://schoolreviewhub.herokuapp.com @nicholaskajoh @TNkemdilim @johnayeni_ @olaoluwa_98"
          data-size="large"
        >
